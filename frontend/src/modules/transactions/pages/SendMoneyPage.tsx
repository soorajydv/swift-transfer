...
import { TRANSFER_PURPOSES, EXCHANGE_RATE } from '@/shared/utils/constants';

import { useTransactions } from '@/modules/transactions/hooks/useTransactions';
import { calculateTransferSummary, formatCurrency } from '@/shared/utils/helpers';
...
export default function SendMoneyPage() {
  ...
  const { senders, isLoading: sendersLoading } = useSenders(true, { page: 1, limit: 100 });
  const { receivers: allReceivers, isLoading: receiversLoading } = useReceivers(undefined, true, { page: 1, limit: 100 });
  const { createTransaction } = useTransactions({}, false);

  // Get only active senders for the dropdown
